...
set title "Degree Distribution of Filtered Token Graph"
...
plot "filtered-token-graph-in-degrees.csv" using "degree":"count" title "In-Degree" \
     smooth mcsplines linestyle 1 linewidth 3, \
     "filtered-token-graph-out-degrees.csv" using "degree":"count" title "Out-Degree" \
